...
package PandaRestaurant.View.Main_Frame;

import PandaRestaurant.Controller.Connection.DatabaseConnection;
import PandaRestaurant.Controller.Event.EventMenuSelected;
import PandaRestaurant.Model.ModelNguoiDung;
import PandaRestaurant.View.Component.Customer_Component.Menu;
import PandaRestaurant.View.Form.Customer_Form.AboutUs_Form;
import PandaRestaurant.View.Form.Customer_Form.AccountC_Form;
import PandaRestaurant.View.Form.Customer_Form.Bill_Form;
import PandaRestaurant.View.Form.Customer_Form.FoodMenu_Form;
import PandaRestaurant.View.Form.MainForm;
import PandaRestaurant.View.Form.Customer_Form.TableMenu_Form;
import PandaRestaurant.View.Form.Customer_Form.Voucher_Form;
...
public class Main_Customer_Frame extends javax.swing.JFrame {
    ...
    public Main_Customer_Frame() throws HeadlessException {
        initComponents();
        init();
        setTitle("Panda Customer Restaurant");
        ...
        menu.addEvent(new EventMenuSelected(){
            ...
            public void menuSelected(int menuIndex, int subMenuIndex)  {
                switch (menuIndex) {
                    case 0 -> {
                        switch (subMenuIndex) {
                            case 0 -> main.showForm(new FoodMenu_Form("Lamb",user));
                            case 1 -> main.showForm(new FoodMenu_Form("Beef",user));
                            case 2 -> main.showForm(new FoodMenu_Form("Combo",user));
                            case 3 -> main.showForm(new FoodMenu_Form("KingCrab",user));
                            case 4 -> main.showForm(new FoodMenu_Form("KoreanFood",user));
                            case 5 -> main.showForm(new FoodMenu_Form("Dessert",user));
                            case 6 -> main.showForm(new FoodMenu_Form("Salad",user));
                            case 7 -> main.showForm(new FoodMenu_Form("Rice",user));
                            case 8 -> main.showForm(new FoodMenu_Form("Pork",user));
                            case 9 -> main.showForm(new FoodMenu_Form("Chevon",user));
                            case 10 -> main.showForm(new FoodMenu_Form("Drink",user));
                            case 11 -> main.showForm(new FoodMenu_Form("Sushi",user));
                            default -> {
                            }
                        }
                    }
