...
import PandaRestaurant.Controller.Event.EventMenu;
import PandaRestaurant.Controller.Event.EventMenuSelected;
import PandaRestaurant.Model.ModelMenu;
import PandaRestaurant.View.Swing.CustomScrollBar.ScrollBarCustom;
import PandaRestaurant.View.Swing.MenuAnimation;
import PandaRestaurant.View.Swing.MenuItem;
...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/astrology.png")), "Menu - Special Dishes", "Lamb - Cừu", "Beef Wagyu - Bò", "Combo - Tiết kiệm", "KingCrab - Cua",
                "KoreanFood - Món Hàn", "Dessert - Tráng Miệng", "Salad - Rau", "Rice - Cơm", "Pork - Heo", "Chevon - Dê", "Drink - Nước giải khát", "Sushi - Sashimi"));
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gp= new GradientPaint(0, 0, Color.decode("#D09476"), 0, getHeight(), Color.decode("#A64A51"));
        g2.setPaint(gp);
