...
package PandaRestaurant.View.Component.LoginAndRegister_Component;

import PandaRestaurant.View.Swing.ButtonOutLine;
import PandaRestaurant.View.Swing.ImageLogo;
...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        subtitle= new JLabel("PandaTeams");
    ...
    private void login(boolean login){
        if(this.isLogin!=login){
            ...
            if(login){
                ...
                description.setText("Hãy tạo mới một tài khoản");
                description1.setText("và bắt đầu trải nghiệm với dịch vụ của Panda");
