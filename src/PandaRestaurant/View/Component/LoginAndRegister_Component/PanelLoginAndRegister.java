...
import PandaRestaurant.View.Swing.Button;
import PandaRestaurant.View.Swing.MyPasswordField;
import PandaRestaurant.View.Swing.MyTextField;
...
public class PanelLoginAndRegister extends javax.swing.JLayeredPane {
    ...
    private void initRegister(ActionListener eventRegister) {
        ...
        label.setForeground(Color.decode("#942630"));
        register.add(label);
        ...
        cmd.setBackground(Color.decode("#912F3F"));
    ...
    private void initLogin(ActionListener eventLogin) {
        ...
        label.setFont(new Font("sansserif", 1, 30));
        label.setForeground(Color.decode("#912F3F"));
        login.add(label);
        //TextField Email
        MyTextField txtEmail = new MyTextField();
        txtEmail.setPrefixIcon(new ImageIcon(getClass().getResource("/Icons/mail.png")));
