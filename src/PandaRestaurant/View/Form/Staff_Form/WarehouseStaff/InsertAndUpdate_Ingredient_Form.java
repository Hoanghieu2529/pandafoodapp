package PandaRestaurant.View.Form.Staff_Form.WarehouseStaff;

import PandaRestaurant.Controller.Service.ServiceStaff;
import PandaRestaurant.Model.ModelNguyenLieu;
...
public class InsertAndUpdate_Ingredient_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txttenNL = new PandaRestaurant.View.Swing.MyTextField();
        lbdongia = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        jSeparator2 = new javax.swing.JSeparator();
        lbDVT = new javax.swing.JLabel();
        txtmaNL = new PandaRestaurant.View.Swing.MyTextField();
        txtdongia = new PandaRestaurant.View.Swing.MyTextField();
        ...
        jComboBoxDVT.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "g", "kg", "tạ", "tấn", "ml", "l", "bao", "cái", "chiếc", "bịch", " ", " ", " " }));
        ...
        cmdOK.setForeground(new java.awt.Color(0, 51, 51));
    ...
    private PandaRestaurant.View.Swing.MyTextField txtdongia;
    private PandaRestaurant.View.Swing.MyTextField txtmaNL;
    private PandaRestaurant.View.Swing.MyTextField txttenNL;
