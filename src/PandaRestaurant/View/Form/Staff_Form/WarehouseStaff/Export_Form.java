...
public class Export_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtslPXK = new PandaRestaurant.View.Swing.MyTextField();
        lbPXK = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablePXK = new PandaRestaurant.View.Swing.Table();
        cmdAdd = new PandaRestaurant.View.Swing.Button();
        cmdCT = new PandaRestaurant.View.Swing.Button();
        ...
        cmdCT.setBackground(new java.awt.Color(0, 0, 51));
    ...
    private PandaRestaurant.View.Swing.Button cmdCT;
    ...
    private PandaRestaurant.View.Swing.Table tablePXK;
    private PandaRestaurant.View.Swing.MyTextField txtSearch;
    private PandaRestaurant.View.Swing.MyTextField txtslPXK;
