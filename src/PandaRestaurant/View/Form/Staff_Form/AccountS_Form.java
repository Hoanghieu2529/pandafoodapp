package PandaRestaurant.View.Form.Staff_Form;

import PandaRestaurant.Controller.Service.ServiceStaff;
import PandaRestaurant.Model.ModelNhanVien;
import PandaRestaurant.Model.ModelNguoiDung;
import PandaRestaurant.View.Dialog.MS_ChangePassword;
import PandaRestaurant.View.Dialog.MS_ConfirmRename;
...
private MS_ChangePassword changepass;
    ...
    private void initComponents() {
        ...
        bg = new PandaRestaurant.View.Swing.PanelRound();
        pic = new PandaRestaurant.View.Swing.ImageAvatar();
        lbmaNV = new javax.swing.JLabel();
        txtngVL = new PandaRestaurant.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenNV = new javax.swing.JLabel();
        txttenNV = new PandaRestaurant.View.Swing.MyTextField();
        lbngVL = new javax.swing.JLabel();
        lbCvu = new javax.swing.JLabel();
        txtCvu = new PandaRestaurant.View.Swing.MyTextField();
        lbNQL = new javax.swing.JLabel();
        txtMaNQL = new PandaRestaurant.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lbEmail = new javax.swing.JLabel();
        txtemail = new PandaRestaurant.View.Swing.MyTextField();
        lbmk = new javax.swing.JLabel();
        txtmatkhau = new PandaRestaurant.View.Swing.MyPasswordField();
        jSeparator2 = new javax.swing.JSeparator();
        cmdDMK = new PandaRestaurant.View.Swing.Button();
        lbRole = new javax.swing.JLabel();
        txtrole = new PandaRestaurant.View.Swing.MyTextField();
        txtSDT = new PandaRestaurant.View.Swing.MyTextField();
        lbSDT = new javax.swing.JLabel();
        txtmaNV = new PandaRestaurant.View.Swing.MyTextField();

        setBackground(new java.awt.Color(222, 222, 222));

        bg.setBackground(new java.awt.Color(247, 247, 247));

        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/karina.jpg"))); // NOI18N
        ...
        titleKH.setForeground(new java.awt.Color(147, 5, 13));
        ...
        titleND.setForeground(new java.awt.Color(147, 5, 13));
    ...
    private PandaRestaurant.View.Swing.PanelRound bg;
    private PandaRestaurant.View.Swing.Button cmdDMK;
    ...
    private PandaRestaurant.View.Swing.ImageAvatar pic;
    private javax.swing.JLabel titleKH;
    private javax.swing.JLabel titleND;
    private PandaRestaurant.View.Swing.MyTextField txtCvu;
    private PandaRestaurant.View.Swing.MyTextField txtMaNQL;
    private PandaRestaurant.View.Swing.MyTextField txtSDT;
    private PandaRestaurant.View.Swing.MyTextField txtemail;
    private PandaRestaurant.View.Swing.MyTextField txtmaNV;
    private PandaRestaurant.View.Swing.MyPasswordField txtmatkhau;
    private PandaRestaurant.View.Swing.MyTextField txtngVL;
    private PandaRestaurant.View.Swing.MyTextField txtrole;
    private PandaRestaurant.View.Swing.MyTextField txttenNV;
