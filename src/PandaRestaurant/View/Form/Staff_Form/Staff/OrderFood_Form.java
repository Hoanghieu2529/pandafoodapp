...
public class OrderFood_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtTableID = new PandaRestaurant.View.Swing.MyTextField();
        cmdBack = new javax.swing.JLabel();
        TypeMenu = new javax.swing.JComboBox<>();
        lbKH = new javax.swing.JLabel();
        txtKH = new PandaRestaurant.View.Swing.MyTextField();
        ...
        lbMenu.setForeground(new java.awt.Color(147, 5, 13));
        ...
        TypeMenu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Lamb", "Beef Wagyu", "Combo", "KingCard", "Korean Food", "Dessert", "Salad", "Rice", "Pork", "Chevon", "Drink", "Sushi Sashimi" }));
    ...
    private PandaRestaurant.View.Swing.MyTextField txtKH;
    private PandaRestaurant.View.Swing.MyTextField txtSearch;
    private PandaRestaurant.View.Swing.MyTextField txtTableID;
