package PandaRestaurant.View.Form.Staff_Form.Staff;
...
import PandaRestaurant.Model.ModelCTHD;
...
import PandaRestaurant.View.Dialog.MS_PaymentSuccess;
import PandaRestaurant.View.Dialog.MS_Success;
import PandaRestaurant.View.Form.MainForm;
import PandaRestaurant.View.Main_Frame.Main_Admin_Frame;
...
public class BillS_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdOK = new PandaRestaurant.View.Swing.ButtonOutLine();
        cmdCancel = new PandaRestaurant.View.Swing.ButtonOutLine();
        lbNgHD = new javax.swing.JLabel();
        txtidHD = new PandaRestaurant.View.Swing.MyTextField();
        lbidHD = new javax.swing.JLabel();
        jSeparator3 = new javax.swing.JSeparator();
        cmdExportBill = new PandaRestaurant.View.Swing.Button();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableCTHD = new PandaRestaurant.View.Swing.Table();
        lbTienmonan = new javax.swing.JLabel();
        txtTienmonan = new PandaRestaurant.View.Swing.MyTextField();
        lbTiengiam = new javax.swing.JLabel();
        txtTiengiam = new PandaRestaurant.View.Swing.MyTextField();
        lbTongtien = new javax.swing.JLabel();
        txtTongtien = new PandaRestaurant.View.Swing.MyTextField();
        lbTienKH = new javax.swing.JLabel();
        txtTienKH = new PandaRestaurant.View.Swing.MyTextField();
        lbTientra = new javax.swing.JLabel();
        txtTientra = new PandaRestaurant.View.Swing.MyTextField();
        lbidKH = new javax.swing.JLabel();
        txtidKH = new PandaRestaurant.View.Swing.MyTextField();
        ...
        cmdOK.setForeground(new java.awt.Color(0, 51, 0));
        ...
        cmdCancel.setForeground(new java.awt.Color(147, 5, 13));
        ...
        cmdExportBill.setBackground(new java.awt.Color(147, 5, 13));
    ...
    private PandaRestaurant.View.Swing.Button cmdExportBill;
    ...
    private PandaRestaurant.View.Swing.Table tableCTHD;
    private PandaRestaurant.View.Swing.MyTextField txtTienKH;
    private PandaRestaurant.View.Swing.MyTextField txtTiengiam;
    private PandaRestaurant.View.Swing.MyTextField txtTienmonan;
    private PandaRestaurant.View.Swing.MyTextField txtTientra;
    private PandaRestaurant.View.Swing.MyTextField txtTongtien;
    private PandaRestaurant.View.Swing.MyTextField txtidHD;
    private PandaRestaurant.View.Swing.MyTextField txtidKH;
