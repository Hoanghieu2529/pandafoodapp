...
import PandaRestaurant.Model.ModelCard;
import PandaRestaurant.Model.ModelChart;
...
public class RevenueReport_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Crevenue = new PandaRestaurant.View.Component.Admin_Component.Card();
        Cexpenses = new PandaRestaurant.View.Component.Admin_Component.Card();
        Cprofit = new PandaRestaurant.View.Component.Admin_Component.Card();
        lbDate = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jSeparator3 = new javax.swing.JSeparator();
        lbchart = new javax.swing.JLabel();
        lineChart = new PandaRestaurant.View.Swing.Chart.LineChart();
        ...
        Crevenue.setColor1(new java.awt.Color(153, 0, 51));
        Crevenue.setColor2(new java.awt.Color(255, 204, 153));
        panelCard.add(Crevenue);

        Cexpenses.setColor1(new java.awt.Color(204, 204, 255));
        Cexpenses.setColor2(new java.awt.Color(51, 51, 0));
        panelCard.add(Cexpenses);

        Cprofit.setColor1(new java.awt.Color(51, 51, 0));
        Cprofit.setColor2(new java.awt.Color(0, 153, 153));
        panelCard.add(Cprofit);

        lbDate.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        lbDate.setForeground(new java.awt.Color(147, 5, 13));
        ...
        filter.setForeground(new java.awt.Color(147, 5, 13));
    ...
    private PandaRestaurant.View.Component.Admin_Component.Card Cexpenses;
    private PandaRestaurant.View.Component.Admin_Component.Card Cprofit;
    private PandaRestaurant.View.Component.Admin_Component.Card Crevenue;
    ...
    private PandaRestaurant.View.Swing.Chart.LineChart lineChart;
