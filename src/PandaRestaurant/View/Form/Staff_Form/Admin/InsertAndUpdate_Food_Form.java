...
public class InsertAndUpdate_Food_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txttenMA = new PandaRestaurant.View.Swing.MyTextField();
        jSeparator1 = new javax.swing.JSeparator();
        jSeparator2 = new javax.swing.JSeparator();
        lbloai = new javax.swing.JLabel();
        txtmaMA = new PandaRestaurant.View.Swing.MyTextField();
        ...
        txtgia = new PandaRestaurant.View.Swing.MyTextField();
        cmdStop = new PandaRestaurant.View.Swing.Button();
        ...
        cbboxLoai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Beef", "Combo", "Chevon", "Dessert", "Drink", "KingCrab", "KoreanFood", "Lamb", "Rice", "Pork", "Salad", "Sushi" }));
        ...
        cmdStop.setBackground(new java.awt.Color(147, 5, 13));
    ...
    private PandaRestaurant.View.Swing.Button cmdStop;
    ...
    private PandaRestaurant.View.Swing.MyTextField txtgia;
    private PandaRestaurant.View.Swing.MyTextField txtmaMA;
    private PandaRestaurant.View.Swing.MyTextField txttenMA;
