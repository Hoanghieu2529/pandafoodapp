package PandaRestaurant.View.Form.Staff_Form.Admin;
...
import PandaRestaurant.View.Dialog.MS_Admin_Confirm;
...
public class InsertAndUpdate_Staff_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txttSDT = new PandaRestaurant.View.Swing.MyTextField();
        lbmaNQL = new javax.swing.JLabel();
        txtmaNQL = new PandaRestaurant.View.Swing.MyTextField();
        cmdKick = new PandaRestaurant.View.Swing.Button();
        ...
        cbboxCvu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bep", "Kho", "Phuc vu", "Quan ly", "Tiep tan", "Thu ngan" }));
        ...
        cmdKick.setBackground(new java.awt.Color(147, 5, 13));
    ...
    private PandaRestaurant.View.Swing.Button cmdKick;
    ...
    private PandaRestaurant.View.Swing.MyTextField txttSDT;
