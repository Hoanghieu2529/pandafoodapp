...
public class ImportStatistic_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtprofit = new PandaRestaurant.View.Swing.MyTextField();
        lbCus = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablePNK = new PandaRestaurant.View.Swing.Table();
        lbDate = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        filter = new javax.swing.JComboBox<>();
        cmdCTNK = new PandaRestaurant.View.Swing.Button();
        cmdExcel = new PandaRestaurant.View.Swing.Button();
        ...
        cmdCTNK.setBackground(new java.awt.Color(147, 5, 13));
        ...
        cmdExcel.setBackground(new java.awt.Color(147, 5, 13));
    ...
    private PandaRestaurant.View.Swing.Button cmdCTNK;
    private PandaRestaurant.View.Swing.Button cmdExcel;
    ...
    private PandaRestaurant.View.Swing.Table tablePNK;
    private PandaRestaurant.View.Swing.MyTextField txtSearch;
    private PandaRestaurant.View.Swing.MyTextField txtprofit;
