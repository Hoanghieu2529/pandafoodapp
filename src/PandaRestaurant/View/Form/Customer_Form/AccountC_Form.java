...
public class AccountC_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtmaKH = new PandaRestaurant.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenKH = new javax.swing.JLabel();
        txttenKH = new PandaRestaurant.View.Swing.MyTextField();
        lbngayTG = new javax.swing.JLabel();
        lbdso = new javax.swing.JLabel();
        txtdso = new PandaRestaurant.View.Swing.MyTextField();
        lbdTL = new javax.swing.JLabel();
        txtdiemtl = new PandaRestaurant.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        txtngayTG = new PandaRestaurant.View.Swing.MyTextField();
    ...
    private PandaRestaurant.View.Swing.MyTextField txtdiemtl;
    private PandaRestaurant.View.Swing.MyTextField txtdso;
    private PandaRestaurant.View.Swing.MyTextField txtemail;
    private PandaRestaurant.View.Swing.MyTextField txtmaKH;
    private PandaRestaurant.View.Swing.MyPasswordField txtmatkhau;
    private PandaRestaurant.View.Swing.MyTextField txtngayTG;
    private PandaRestaurant.View.Swing.MyTextField txtrole;
    private PandaRestaurant.View.Swing.MyTextField txttenKH;
